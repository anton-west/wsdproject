...
export { viewEngine, dejsEngine, oakAdapter } from "https://raw.githubusercontent.com/deligenius/view-engine/master/mod.ts";
export { Client } from "https://deno.land/x/postgres@v0.4.5/mod.ts";
export * as bcrypt from "https://deno.land/x/bcrypt@v0.2.4/mod.ts";
export * as vs from "https://deno.land/x/validasaur@v0.15.0/mod.ts";
...
export * as test from "https://deno.land/std@0.78.0/testing/asserts.ts";